 ...
 * m бурлей, значит он может взять любое целое количество бурлей от 0 до m включительно.
 *
 ...
 * Первая строка содержит два целых числа n и m (1 ≤ n ≤ 10^5, 1 ≤ m ≤ 10^9) (1 ≤ n ≤ 10^5,1 ≤ m ≤ 10^9) — длина списка
 * подарков и размер предодобренного кредита.
 * Вторая строка содержит n целых чисел — цены подарков ai (1 ≤ a1 ≤ 10^9).
 *
